...
public class FindIdController {
	 ...
	 * @PostMapping("/findPw")
	 * 
	 * @ResponseBody public String findPw(HttpServletRequest req) { String val =
	 * null;
	 * 
	 * try {
	 * 
	 * String id = req.getParameter("id"); // String email =
	 * req.getParameter("email"); String name = req.getParameter("name"); String
	 * randomPw = req.getParameter("randomPw");
	 * 
	 * int n = findIddao.find(id, name); if(n!=0) {
	 * 
	 * findIddao.updaterandomPw(id, name, randomPw); val = randomPw; } else { val =
	 * ""; }
	 * 
