        ...
        <div class="category-All1">
        	<div class="category1-All">
	        	<p class="bookCate">판타지</p>
	        		<div class="book1-All">
	        			<c:forEach items="${fantasy_list}" var="fl">
	        			<div class="book">
	        				
	        				<input type=hidden id=bookNum>
	        				<div class="bookImg">
	        					<img src="${fl.book_cover}" class="book_img" picname="${fl.book_num}">	        
	        				</div>
	        				<div class="bookName">
	        					<p id=name>${fl.book_name}</p>
	        					<p id=write>${fl.author}</p>
	        					<p id=date>${fl.publication}</p>
	        					<p id=price>${fl.book_price}</p>	        					
	        				</div>	
	        			</div>
	        			</c:forEach> 	        			
        			</div>
